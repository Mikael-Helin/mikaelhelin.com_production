import { c as create_ssr_component, a as subscribe, e as escape, b as each } from './ssr-D_VSFOBM.js';
import { g as getCookie, s as storeLanguage } from './stores-y3q_sMZ9.js';
import './index2-ChKc9uJW.js';

const cv_last_update = "2023-12";
const introduction = {
  "us": "Born and raised in Stockholm, Sweden with roots from Finland. From an early age, science captivated me, inspiring my journey to becoming the engineer I am today. Traveling to over 30 countries, exploring diverse cultures, and earning certifications such as diving have partially satisfied my curiosity about the world. I strive to channel this passion into my work and engage deeply with challenging tasks.",
  "se": "Född och uppvuxen i Stockholm, Sverige, med finska rötter. Redan som barn fascinerades jag av vetenskap, vilket inspirerade mig att bli den civilingenjör jag är idag. Efter att ha rest till över 30 länder, upplevt olika kulturer och fått erfarenheter, såsom dykning, har jag stillat en del av min nyfikenhet på världen. Jag strävar efter att använda motsvarande passion för att bidra med energi och perspektiv till mitt arbete.",
  "fi": "Syntynyt ja kasvanut Tukholmassa, Ruotsissa, jossa on juuret Suomesta. Jo lapsena tiede kiehtoi minua, mikä inspiroi minua ryhtymään civilingenjöriksi. Matkustamalla yli 30 maahan, kokemalla eri kulttuureja ja hankkimalla taitoja, kuten sukellustodistuksia, olen osittain tyydyttänyt uteliaisuuteni maailmaa kohtaan. Pyrin tuomaan tätä intohimoa työni kautta ja syventymään haastaviin tehtäviin.",
  "no": "Født og oppvokst i Stockholm, Sverige, med finske røtter. Allerede som barn ble jeg fascinert av vitenskap, noe som inspirerte meg til å bli den civilingeniør jeg er i dag. Gjennom å reise til over 30 land, oppleve forskjellige kulturer og tilegne meg ferdigheter som dykking, har jeg delvis tilfredsstilt min nysgjerrighet på verden. Jeg håper å kunne bruke denne lidenskapen i arbeidet mitt og fordype meg i utfordrende oppgaver.",
  "dk": "Født og opvokset i Stockholm, Sverige, med finske rødder. Allerede som barn blev jeg fascineret af videnskab, hvilket inspirerede mig til at blive den civilingeniør, jeg er i dag. Gennem at rejse til over 30 lande, opleve forskellige kulturer og tilegne mig færdigheder som dykning, har jeg delvist stillet min nysgerrighed på verden. Jeg håber at kunne bringe denne passion til mit arbejde og fordybe mig i udfordrende opgaver.",
  "is": "Fæddur og uppalinn í Stokkhólmi, Svíþjóð, með rætur frá Finnlandi. Strax sem barn heillaði vísindin mig, sem veitti mér innblástur til að verða civilingenjör. Með því að ferðast til yfir 30 landa, upplifa mismunandi menningarheima og öðlast færni eins og kafaravottorð, hef ég að hluta til fullnægt forvitni minni um heiminn. Ég vonast til að nýta þessa ástríðu í starfi mínu og takast á við krefjandi verkefni.",
  "de": "Geboren und aufgewachsen in Stockholm, Schweden, mit Wurzeln in Finnland. Schon in jungen Jahren faszinierte mich die Wissenschaft, was mich inspirierte, der Ingenieur zu werden, der ich heute bin. Durch Reisen in über 30 Länder, das Erleben verschiedener Kulturen und das Erlangen von Fähigkeiten wie dem Tauchen habe ich meine Neugier auf die Welt teilweise gestillt. Ich bemühe mich, diese Leidenschaft in meine Arbeit einzubringen und mich mit herausfordernden Aufgaben auseinanderzusetzen.",
  "es": "Nacido y criado en Estocolmo, Suecia, con raíces en Finlandia. Desde pequeño, la ciencia me cautivó, inspirándome a convertirme en el ingeniero que soy hoy. Al viajar a más de 30 países, explorar diversas culturas y adquirir habilidades como el buceo, he satisfecho parcialmente mi curiosidad por el mundo. Me esfuerzo por canalizar esta pasión en mi trabajo y abordar tareas desafiantes.",
  "fr": "Né et élevé à Stockholm, en Suède, avec des racines finlandaises. Dès mon jeune âge, la science m'a captivé, m'inspirant à devenir l'ingénieur que je suis aujourd'hui. En voyageant dans plus de 30 pays, en explorant diverses cultures et en acquérant des compétences comme la plongée, j'ai partiellement assouvi ma curiosité pour le monde. Je m'efforce de canaliser cette passion dans mon travail et de m'engager pleinement dans des tâches stimulantes.",
  "pt": "Nascido e criado em Estocolmo, Suécia, com raízes na Finlândia. Desde jovem, a ciência me cativou, inspirando-me a me tornar o engenheiro que sou hoje. Viajando para mais de 30 países, explorando culturas diversas e adquirindo habilidades como mergulho, saciei parcialmente minha curiosidade pelo mundo. Esforço-me para canalizar essa paixão no meu trabalho e me envolver profundamente em tarefas desafiadoras.",
  "tr": "Stockholm, İsveç'te Finlandiya kökenli olarak doğup büyüdüm. Bilim, çocukluğumdan beri beni büyüledi ve bugün olduğum mühendis olmama ilham verdi. 30'dan fazla ülkeye seyahat ederek, farklı kültürleri keşfederek ve dalış gibi beceriler kazanarak dünyaya olan merakımı kısmen tatmin ettim. Bu tutkuyu işime taşımaya ve zorlu görevlerle ilgilenmeye çalışıyorum.",
  "gr": "Γεννημένος και μεγαλωμένος στη Στοκχόλμη, Σουηδία με ρίζες από τη Φινλανδία. Ήδη από την παιδική ηλικία, η Επιστήμη με γοήτευε, που με έκανε να γίνω ο Υπολογιστικός Επιστήμονας που είμαι σήμερα. Περίεργος για τον κόσμο, επισκέφθηκα πάνω από 30 χώρες, απέκτησα πιστοποιητικά κατάδυσης και εξερεύνησα διάφορους πολιτισμούς. Ελπίζω να μεταφέρω το πνεύμα του ενθουσιασμού μου στη δουλειά μου και να εμβαθύνω στις προκλήσεις που πρέπει να αντιμετωπίσω.",
  "ru": "Родился и вырос в Стокгольме, Швеция, с корнями из Финляндии. С раннего возраста наука меня очаровывала, вдохновляя на путь к тому, чтобы стать инженером, которым я являюсь сегодня. Путешествуя по более чем 30 странам, изучая различные культуры и получая опыт в дайвинге, я частично удовлетворил своё любопытство о мире. Я стремлюсь направить эту страсть в свою работу и углубиться в выполнение сложных задач.",
  "cn": "我出生并成长于瑞典斯德哥尔摩，祖籍芬兰。从小，科学就深深吸引了我，激励我走上了成为今天这名工程师的道路。我曾游历超过30个国家，探索不同文化，并获得了潜水经验，这在一定程度上满足了我对世界的好奇心。我努力将这份热情投入到我的工作中，并全身心投入到具有挑战性的任务中。",
  "my": "Saya dilahirkan dan dibesarkan di Stockholm, Sweden, dengan warisan dari Finland. Sejak kecil, sains telah memikat saya dan menginspirasi perjalanan saya menjadi jurutera seperti hari ini. Dengan melancong ke lebih dari 30 negara, meneroka pelbagai budaya, dan memperoleh pengalaman dalam menyelam, saya telah sebahagiannya memuaskan rasa ingin tahu saya tentang dunia. Saya berusaha untuk menyalurkan semangat ini ke dalam kerja saya dan menghadapi tugas-tugas yang mencabar.",
  "vn": "Sinh ra và lớn lên tại Stockholm, Thụy Điển, với gốc gác từ Phần Lan. Ngay từ nhỏ, tôi đã bị cuốn hút bởi khoa học, điều này đã truyền cảm hứng cho tôi trở thành kỹ sư như ngày hôm nay. Tôi đã du lịch đến hơn 30 quốc gia, khám phá nhiều nền văn hóa khác nhau và đạt được các chứng chỉ như lặn biển, phần nào thỏa mãn sự tò mò của tôi về thế giới. Tôi luôn cố gắng truyền đam mê này vào công việc và tận tâm với những thử thách đầy cam go.",
  "th": "ฉันเกิดและเติบโตในสตอกโฮล์ม ประเทศสวีเดน โดยมีเชื้อสายจากฟินแลนด์ ตั้งแต่วัยเยาว์ วิทยาศาสตร์ได้ดึงดูดใจฉันอย่างมาก ซึ่งเป็นแรงบันดาลใจให้ฉันกลายเป็นวิศวกรอย่างที่ฉันเป็นในปัจจุบัน การเดินทางไปยังกว่า 30 ประเทศ การสำรวจวัฒนธรรมที่หลากหลาย และการได้รับประสบการณ์การดำน้ำ ได้เติมเต็มความอยากรู้อยากเห็นของฉันเกี่ยวกับโลกไปบ้างแล้ว ฉันมุ่งมั่นที่จะนำความหลงใหลนี้ไปใช้ในงานของฉันและมีส่วนร่วมอย่างลึกซึ้งกับงานที่ท้าทาย",
  "il": "נולדתי וגדלתי בשטוקהולם, שוודיה, עם שורשים מפינלנד. מאז ילדותי, המדע ריתק אותי, מה שהוביל אותי להפוך למהנדס שאני היום. לאחר שטיילתי בלמעלה מ-30 מדינות, חקרתי תרבויות שונות ורכשתי ניסיון בצלילה, הצלחתי בחלקי לספק את סקרנותי לעולם. אני שואף לנתב את התשוקה הזו לעבודה שלי ולהתעמק במשימות מאתגרות.",
  "ae": "وُلدت ونشأت في ستوكهولم، السويد، مع جذور من فنلندا. منذ الطفولة، أثارت العلوم إعجابي وألهمت رحلتي لأصبح المهندس الذي أنا عليه اليوم. من خلال السفر إلى أكثر من 30 دولة، واستكشاف ثقافات مختلفة، واكتساب خبرة في الغوص، تمكنت جزئيًا من إشباع فضولي عن العالم. أسعى إلى توجيه هذا الشغف نحو عملي والتعمق في المهام الصعبة.",
  "in": "मैं स्टॉकहोम, स्वीडन में पैदा हुआ और पला-बढ़ा, जिसकी जड़ें फ़िनलैंड से हैं। बचपन से ही विज्ञान ने मुझे आकर्षित किया, जिसने मुझे आज का इंजीनियर बनने के लिए प्रेरित किया। मैंने 30 से अधिक देशों की यात्रा की, विभिन्न संस्कृतियों का अन्वेषण किया और डाइविंग का अनुभव प्राप्त किया, जिससे दुनिया के प्रति मेरी जिज्ञासा आंशिक रूप से संतुष्ट हुई। मैं इस जुनून को अपने काम में लागू करने और चुनौतीपूर्ण कार्यों में गहराई तक जाने का प्रयास करता हूँ।"
};
const other_names = {
  "cv": {
    "us": "Curriculum Vitae",
...
const objectives = {
  ...
  "dk": [
    "Som en dedikeret beregningsforsker ligger min primære interesse i at udnytte mine færdigheder inden for matematisk modellering, data science og maskinlæring. Jeg søger muligheder, hvor jeg kan bidrage og vokse inden for domæner som:",
    [
      "Matematisk analyse, modellering og beregning samt data science.",
      "Algoritmeudvikling og applikationsprogrammering.",
      "Helst inden for fin-tech, finans og bank."
    ],
    "Nogle af mine ideelle arbejdsmiljøpræferencer er:",
    [
      "Udvikling under Linux-miljøet.",
      "Bland programmeringssprog i mit arbejde, helst til:",
      [
        "Prototypalgoritmer i Matlab/R/Python.",
        "Algoritmer til produktion i CUDA/C/C++/Numba."
      ]
    ]
  ],
  "is": [
    "Sem reiknifræðingur liggur helsta áhugi minn í því að nýta færni mína í stærðfræðilegri mótun, gagnavísindum og vélnám. Ég er að leita að tækifærum þar sem ég get gagnast og vaxið í svæðum eins og:",
    [
      "Stærðfræðileg greining, mótun og reikningur og gagnavísindi.",
      "Algrímaþróun og forritun.",
      "Helst innan fin-tech, fjármál og banka."
    ],
    "Sumar af uppáhalds umhverfisstillingum mínum eru:",
    [
      "Þróun undir Linux-umhverfinu.",
      "Blanda forritunarmálum í vinnunni minni, helst til:",
      [
        "Prótotýpur í Matlab/R/Python.",
        "Algrímar fyrir framleiðslu í CUDA/C/C++/Numba."
      ]
    ]
  ],
  "de": [
  ...
  "vn": [
    "Là một nhà khoa học tính toán tận tâm, mối quan tâm chính của tôi là tận dụng kỹ năng của mình trong Mô hình Toán học, Khoa học Dữ liệu và Học Máy. Tôi đang tìm kiếm cơ hội để đóng góp và phát triển trong các lĩnh vực như:",
    [
      "Khoa học tính toán hoặc dữ liệu, mô hình hóa và phân tích toán học,",
      "Phát triển thuật toán và lập trình ứng dụng.",
      "Ưu tiên trong các lĩnh vực Fin-Tech, tài chính và ngân hàng."
    ],
    "Một số tiêu chí về môi trường làm việc lý tưởng của tôi là:",
    [
      "Phát triển trong môi trường Linux.",
      "Kết hợp nhiều ngôn ngữ lập trình trong công việc, ưu tiên:",
      [
        "Tạo nguyên mẫu thuật toán bằng Matlab/R/Python.",
        "Xây dựng thuật toán cấp sản xuất bằng CUDA/C/C++/Numba."
      ]
    ]
  ],
  "th": [
...
const core_skills = {
  "us": [
    ...
    [
      ...
      "Experienced in creating custom solvers from mathematical models for computational applications, and I have",
      "a basic understanding of the operation of Debian and Red Hat Linux operating systems."
    ]
  ],
  "se": [
    "Som en beräkningsvetare är mina naturliga kärnkompetenser följande:",
    [
      "Kunnig i att modellera verkliga problem till matematiska modeller.",
      "Erfaren i att skapa anpassade lösare från matematiska modeller för beräkningsprogram, och har",
      "grundläggande förståelse för drift av Debian och Red Hat Linux operativsystem."
    ]
  ],
  "fi": [
  ...
  "no": [
    "Som en beregningsvitenskapsmann er mine naturlige kjernekompetanser følgende:",
    [
  ...
  "dk": [
    "Som en beregningsvidenskabsmand er mine naturlige kernekompetencer følgende:",
    [
      "Dygtig til at oversætte virkelighedsproblemer til matematiske modeller.",
      "Erfaren i at oprette brugerdefinerede løsere fra matematiske modeller til beregningsprogrammer og har",
      "grundlæggende forståelse for drift af Debian og Red Hat Linux-operativsystemer."
    ]
  ],
  "is": [
    "Sem reiknifræðingur eru eðlilegir kjarnahæfileikar mínir eftirfarandi:",
    [
      "Hæfur í því að þýða raunveruleg vandamál í stærðfræðileg mót.",
      "Reynsla í því að búa til sérsniðna leysara úr stærðfræðilegum mótum fyrir reiknirit og",
      "grunnþekkingu á rekstri Debian og Red Hat Linux stýrikerfa."
    ]
  ],
  "de": [
  ...
  "tr": [
    ...
    [
      ...
      "Debian ve Red Hat Linux işletim sistemlerinin çalışmasını temel düzeyde anlama."
    ]
  ],
  "gr": [
    ...
    [
      ...
      "Έμπειρος στη δημιουργία προσαρμοσμένων λύσεων από μαθηματικά μοντέλα για υπολογιστικές εφαρμογές και",
  ...
  "my": [
    "Sebagai seorang saintis pengiraan, kemahiran asas semulajadi saya adalah seperti berikut:",
    [
      "Mahir menterjemahkan masalah dunia nyata ke dalam model matematik.",
      "Berpengalaman dalam membuat penyelesaian khusus dari model matematik untuk aplikasi komputasi, dan mempunyai",
      "pemahaman asas untuk operasi sistem operasi Debian dan Red Hat Linux."
    ]
  ],
  "vn": [
    "Là một nhà khoa học tính toán, các kỹ năng cốt lõi tự nhiên của tôi bao gồm:",
    [
      "Thành thạo trong việc chuyển đổi các vấn đề thực tế thành mô hình toán học.",
      "Có kinh nghiệm tạo ra các bộ giải tùy chỉnh từ mô hình toán học cho các ứng dụng tính toán và có kiến thức cơ bản về cách vận hành hệ điều hành Debian và Red Hat Linux."
    ]
  ],
  "th": [
    ...
    [
      ...
      "มีประสบการณ์ในการสร้างตัวแก้ปัญหาที่กำหนดเองจากแบบจำลองทางคอมพิวเตอร์สำหรับแอปพลิเคชันและ",
...
const work_titles = {
  1: {
    ...
    "dk": "Personlige Projekter",
    "is": "Persónuleg Verkefni",
  ...
  3: {
    ...
    "dk": "Kreditrisikoanalytiker",
    "is": "Kredittriskráðgjafi",
    ...
    "vn": "Nhà phân tích rủi ro tín dụng",
  ...
  4: {
    "us": "Mathematics Consultant",
    "se": "Matematikkonsult",
    "fi": "Matematiikkakonsultti",
    "no": "Matematikkonsulent",
    "dk": "Matematikkonsulent",
    "is": "Stærðfræðikonsulent",
  ...
  7: {
    ...
    "dk": "Matematik- og Engelsklærer",
    "is": "Stærðfræði- og enskukennari",
    ...
    "vn": "Giáo viên Toán học và Tiếng Anh",
...
const work_descriptions = {
  1: {
    ...
    "dk": [
      "Motivationen for de personlige projekter er at bygge en hjemmelaboratoriekluster til en uddannelsesplatform inden for matematik og data.",
      [
        "Øv daglig prompt engineering med ChatGPT.",
        "Brug Red Hat Podman-containere som et alternativ til Docker-containere og Kubernetes.",
        "Konfiguration og scripting af IPv6, DNS, load balancers og reverse proxys med SSL-terminering.",
        "Udvikle en produktionsklar nøgleværdidatabase til brug i et hjemmelaboratorium eller en mindre privat sky."
      ]
    ],
    "is": [
      "Örvunin fyrir persónulegu verkefnin er að byggja heimalaboratoríuklústur í námsstofu í stærðfræði og gögnum.",
      [
        "Æfing daglegra skilaboðafræði með ChatGPT.",
        "Notaðu Red Hat Podman geymslur sem valkost við Docker geymslur og Kubernetes.",
        "Stilling og handrit IPv6, DNS, hlaða jafnvægi og endurspegla fulltrúa með SSL lokun.",
        "Þróa framleiðsluvalinn lykilsafn fyrir notkun í heimalaboratoríum eða minni einkaskýi."
      ]
    ],
    "de": [
    ...
    "vn": [
      "Động lực cho các dự án cá nhân là biến một cụm phòng thí nghiệm tại nhà thành một nền tảng giáo dục trong Khoa học Tính toán, Khoa học Dữ liệu và Máy học.",
      [
        "Luyện tập kỹ thuật prompt hằng ngày với ChatGPT.",
        "Sử dụng các container Red Hat Podman như một lựa chọn thay thế cho Docker và Kubernetes.",
        "Cấu hình và viết script cho IPv6, DNS, bộ cân bằng tải và proxy ngược với chấm dứt SSL.",
        "Xây dựng một kho khóa-giá trị cấp sản xuất để sử dụng trong phòng thí nghiệm tại nhà hoặc đám mây riêng nhỏ."
      ]
    ],
    "th": [
  ...
  2: {
    ...
    "dk": [
      "Meta Bytes, er et start-up selskab, der leverer cloud- og IT-løsninger til forskellige kunder inden for EU.",
      [
        "Min hovedopgave var at udforske nye teknologier til fremtidig forretningsfordele.",
        "Genbrugte teknologier til måling af jordfugtighed fra NASA-vejr satellitdata til droner i præcisionslandbrug.",
        "Designet og evalueret løsere af den traditionelt matematiske type versus maskinlæringstype.",
        "Vi udforskede brugen af open source machine learning software: Tesseract (OCR) og OpenCV, som derefter blev brugt i udviklingen af visuelle dokumentidentifikationsprogrammer.",
        "Vi udforskede anvendelsen af tale-til-tekst transskription.",
        "Vi implementerede sikker informationsudveksling gennem brug af serialisering, NoSQL, hemmelige nøgleværdi databaser og RabbitMQ."
      ]
    ],
    "is": [
      "Meta Bytes, er nýstofnað fyrirtæki sem veitir ský- og IT-lausnir fyrir ýmsar viðskiptavini innan ESB.",
      [
        "Aðalverkefni mitt var að kanna nýjar tækni fyrir framtíðarlega fyrirtækjaþátt.",
        "Endurnýtti tækni til að mæla jarðrakasýrustig úr gögnum veðursatellíta NASA fyrir dróna í nákvæmni landbúnaði.",
        "Hannað og metið lausnaraðila hefðbundins stærðfræðilegs tegundar fyrir vélrænan læringsgerð.",
        "Við kynntum okkur notkun opinn hugbúnaður vélrænan læringshugbúnaður: Tesseract (OCR) og OpenCV sem var þá notað í þróun sjónræn skjala auðkenni forrit.",
        "Við kynntum okkur notkun talskriftar til texta.",
        "Við framkvæmdum örugga upplýsingaflutning með notkun á raðgreiningu, NoSQL, leyndum lykla gildi gagnagrunna og RabbitMQ."
      ]
    ],
    "de": [
    ...
    "vn": [
      "Meta Bytes là một công ty khởi nghiệp cung cấp các giải pháp đám mây và CNTT cho nhiều khách hàng khác nhau trong EU.",
      [
        "Nhiệm vụ chính của tôi là khám phá các công nghệ mới để mang lại lợi ích kinh doanh trong tương lai.",
        "Tái sử dụng công nghệ đo độ ẩm đất từ dữ liệu vệ tinh thời tiết NASA cho máy bay không người lái trong nông nghiệp chính xác.",
        "Thiết kế và đánh giá các bộ giải theo phương pháp toán học truyền thống so với phương pháp học máy.",
        "Chúng tôi đã khám phá việc sử dụng phần mềm học máy mã nguồn mở: Tesseract (OCR) và OpenCV, sau đó được sử dụng để phát triển các chương trình nhận dạng tài liệu trực quan.",
        "Chúng tôi đã nghiên cứu ứng dụng chuyển đổi giọng nói thành văn bản.",
        "Chúng tôi đã triển khai truyền tải thông tin an toàn thông qua việc sử dụng tuần tự hóa, NoSQL, cơ sở dữ liệu khóa-giá trị bí mật và RabbitMQ."
      ]
    ],
    "th": [
  ...
  3: {
    ...
    "dk": [
      "Northmill Bank er en svensk bank, der leverer finansielle tjenester til forbrugere og virksomheder i EU. Jeg arbejdede hos Northmill, før de fik tildelt en banklicens.",
      [
        "Min primære opgave var at løse beregningsintensive analyseproblemer i organisationen.",
        [
          "Med mine beregningsintensive analyser bidrog jeg til beslutningsprocesser på topledelsesniveau.",
          "Håndterede Big Data-problemer, før banken udvidede til dedikeret IT-infrastruktur.",
          "Vi vurderede risici, forudsagde porteføljestørrelser og estimerede antagelser og KPI'er.",
          "Benchmarkede machine learning algoritmer versus traditionelle analytiske metoder."
        ],
        "Markedsanalyse:",
        [
          "Evaluerede og prissatte Google AdWords søgeord for forskellige rankings, tider og kundegrupper."
        ],
        "Adfærdsanalyse:",
        [
          "Udførte adfærdsanalyse og kategorisering af kunder og transaktionstekstdata ved at udnytte regulære udtryk.",
          "Analyserede analytikere til partnere til Northmills i en modforhandling. Resultat: Mere end 14M EUR ekstra overskud på 5 år."
        ],
        "Modellerede og simulerede Northmill Banks kundeadfærd, baseret på underliggende IT-infrastruktur, til kreditstresstest og til beslutningsstøtte.",
        "Assisterede i forberedelserne til Northmill Banks treasury-funktion."
      ]
    ],
    "is": [
      "Northmill Bank er sænska bankinn sem veitir fjármálaþjónustu fyrir neytendur og fyrirtæki í ESB. Ég vann hjá Northmill áður en þeim var veitt bankaleyfi.",
      [
        "Aðalverkefni mitt var að leysa reikniritsháð vandamál í greiningu í fyrirtækinu.",
        [
          "Með reikniritsháðri greiningu minni var ég að stuðla að ákvörðunartöku á stjórnunarstigi.",
          "Hélt utan um stóra gögn vandamál áður en bankinn stækkaði í sérhæfða IT-infrastrúktúr.",
          "Við mat á hættu, spáðum við stærðum fjárfestingar og áætluðum forsendur og KPI.",
          "Benchmarked vélræn kennslu algrímum miðað við hefðbundin greiningaraðferðir."
        ],
        "Markaðsgreining:",
        [
          "Mat á Google AdWords lykilorðum fyrir mismunandi röðun, tíma og viðskiptahópa."
        ],
        "Hugarfaragreining:",
        [
          "Framkvæmd hugarfaragreiningar og flokkun viðskiptavina og texta gögn með því að nota venjulega segðir.",
          "Greindi greiningarmenn Northmills í gegnparta. Niðurstaða: Meira en 14 milljónir evra aukagewinna á 5 árum."
        ],
        "Hönnuði og hermdi hegðun viðskiptavina Northmill Bank, byggð á undirliggjandi IT-infrastrúktúr, fyrir kredit streitu prófanir og fyrir stuðning við ákvarðanatöku.",
        "Hjálpaði við undirbúning Northmill Bank fyrir fjármála starfsemi."
      ]
    ],
    "de": [
    ...
    "vn": [
      "Northmill Bank là một ngân hàng Thụy Điển cung cấp dịch vụ tài chính cho người tiêu dùng và doanh nghiệp trong EU. Tôi làm việc tại Northmill trước khi họ được cấp giấy phép ngân hàng.",
      [
        "Nhiệm vụ chính của tôi là giải quyết các vấn đề phân tích có cường độ tính toán cao trong tổ chức.",
        [
          "Với phân tích tính toán của mình, tôi đã đóng góp vào quá trình ra quyết định ở cấp quản lý cao nhất.",
          "Xử lý các vấn đề về Dữ liệu Lớn (Big Data) trước khi ngân hàng mở rộng sang cơ sở hạ tầng CNTT chuyên dụng.",
          "Chúng tôi đánh giá rủi ro, dự đoán quy mô danh mục đầu tư và ước tính các giả định và chỉ số KPI.",
          "Đánh giá hiệu suất của các thuật toán học máy so với các phương pháp phân tích truyền thống."
        ],
        "Phân tích Tiếp thị:",
        [
          "Đánh giá và định giá từ khóa Google AdWords theo các thứ hạng, thời điểm và nhóm khách hàng khác nhau."
        ],
        "Phân tích Hành vi:",
        [
          "Thực hiện phân tích hành vi và phân loại khách hàng, dữ liệu văn bản giao dịch bằng cách sử dụng các biểu thức chính quy.",
          "Phân tích các nhà phân tích đối tác của Northmill trong một cuộc đàm phán đối kháng. Kết quả: Hơn 14 triệu EUR lợi nhuận bổ sung trong 5 năm."
        ],
        "Mô hình hóa và mô phỏng hành vi khách hàng của Northmill Bank, dựa trên cơ sở hạ tầng CNTT nền tảng, để kiểm tra áp lực tín dụng và hỗ trợ ra quyết định.",
        "Hỗ trợ công tác chuẩn bị cho chức năng ngân quỹ của Northmill Bank."
      ]
    ],
    "th": [
  ...
  4: {
    ...
    "dk": [
      "Ackebrink er et firma, der leverer konsulenter til forskellige markedsuddannelsesinstitutioner i Sverige.",
      [
        "Min hovedopgave var at undervise i matematik og programmeringslogik for studerende inden for datalogi.",
        "Deltog i udviklingen af kursusmateriale og kursusplaner."
      ]
    ],
    "is": [
      "Ackebrink er fyrirtæki sem veitir ráðgjafa til ýmissa markaðsfræðslufræðslustofnana í Svíþjóð.",
      [
        "Aðalverkefni mitt var að kenna stærðfræði og forritunarskilning til nemenda innan tölvunarfræði.",
        "Tók þátt í þróun áfanga og námskrár."
      ]
    ],
    "de": [
    ...
    "vn": [
      "Ackebrink là một công ty cung cấp tư vấn viên cho các cơ sở giáo dục thị trường khác nhau tại Thụy Điển.",
      [
        "Nhiệm vụ chính của tôi là giảng dạy toán học và logic lập trình cho sinh viên trong ngành khoa học máy tính.",
        "Tham gia phát triển tài liệu khóa học và kế hoạch giảng dạy."
      ]
    ],
    "th": [
  ...
  5: {
    ...
    "dk": [
      "Nord Fondkommission specialiserede sig i at forvalte fonde og finansielle aktiver til personer med høj indkomst i Sverige, hvor flere finansielle produkter overgik markedsindekserne. Nord Fondkommission mistede sin licens for ikke at følge reglerne for den svenske Finanstilsynet.",
      [
        "Min hovedopgave var at udføre risiko- og stresstest på strukturerede produkter og porteføljer.",
        "Havde meget varierende jobopgaver, som:",
        [
          "Havde Chief Information-roller.",
          "Udviklede automatiserede scripts og værktøjer til backoffice-brug.",
          "Løste enkle IT-problemer for forhandlerne af Nord Fondkommissions finansielle produkter."
        ]
      ]
    ],
    "is": [
      "Nord Fondkommission sérhæfðist í að stjórna fjárfestum og fjármagni, fyrir hátekjandi í Svíþjóð, þar sem nokkrir fjárfestingar voru betri en markaðsþættir. Nord Fondkommission tapaði leyfi sínu fyrir það að fylgja ekki reglum Svíþjóðar Fjármálaeftirlitsins.",
      [
        "Aðalverkefni mitt var að framkvæma áhættu- og streitu próf á skipulögðum vörum og fjárfestum.",
        "Hafði mjög breytilegar starfsverkefni, svo sem:",
        [
          "Hafði Chief Information hlutverk.",
          "Þróaði sjálfvirk skriftur og tæki fyrir bakstofu notkun.",
          "Leysti einföld vandamál í IT fyrir endursölu Nord Fondkommissions fjármálum."
        ]
      ]
    ],
    "de": [
    ...
    "vn": [
      "Nord Fondkommission chuyên quản lý quỹ và tài sản tài chính cho những người có thu nhập cao tại Thụy Điển, nơi một số sản phẩm tài chính đã vượt trội hơn so với chỉ số thị trường. Nord Fondkommission đã mất giấy phép do không tuân thủ các quy định của Cơ quan Giám sát Tài chính Thụy Điển.",
      [
        "Nhiệm vụ chính của tôi là thực hiện các bài kiểm tra rủi ro và kiểm tra áp lực trên các sản phẩm và danh mục đầu tư có cấu trúc.",
        "Đã đảm nhận nhiều công việc khác nhau, chẳng hạn như:",
        [
          "Đảm nhận vai trò Giám đốc Thông tin (Chief Information).",
          "Phát triển các tập lệnh và công cụ tự động hóa cho bộ phận hậu mãi.",
          "Giải quyết các vấn đề IT đơn giản cho các nhà phân phối sản phẩm tài chính của Nord Fondkommission."
        ]
      ]
    ],
    "th": [
  ...
  6: {
    ...
    "dk": [
      "Jeg var ejer af enkeltmandsvirksomheden Multitronics, som jeg afsluttede i 2014. (Mit firma må ikke forveksles med det nye Multitronics, som har andre ejere)",
      [
        "Importeret ny elektronik og computerhardware fra Asien samt købt og solgt brugte computere.",
        "Udførte installationer og IT-hjælp.",
        "Byggede websteder."
      ]
    ],
    "is": [
      "Ég var eigandi einstaklingsfyrirtækisins Multitronics sem ég lýsti út árið 2014. (Fyrirtæki mitt ætti ekki að rugla saman við nýja Multitronics sem hefur aðra eigendur)",
      [
        "Flytja inn nýja rafmagnsefni og tölvuvörur frá Asíu og keypt og selt notaðar tölvur.",
        "Framkvæma uppsetningar og IT-hjálp.",
        "Byggt vefsíður."
      ]
    ],
    "de": [
    ...
    "vn": [
      "Tôi là chủ sở hữu của công ty tư nhân Multitronics, mà tôi đã chấm dứt vào năm 2014. (Công ty của tôi không nên bị nhầm lẫn với Multitronics mới, công ty có các chủ sở hữu khác)",
      [
        "Nhập khẩu thiết bị điện tử mới và phần cứng máy tính từ châu Á cũng như mua và bán máy tính đã qua sử dụng.",
        "Thực hiện cài đặt và hỗ trợ IT.",
        "Xây dựng trang web."
      ]
    ],
    "th": [
  ...
  7: {
    ...
    "dk": [
      "Princess Chulabhorn's College Phitsanulok er en videnskabelig højskole for talentfulde og begavede børn i Thailand.",
      [
        "Min hovedopgave var at undervise matematik og engelsk til elever i grundskolen og gymnasiet.",
        "Deltog også i udviklingen af kursusmaterialer og kursusplaner."
      ]
    ],
    "is": [
      "Princess Chulabhorn's College Phitsanulok er vísindaskóli fyrir hæfileika og hæfileika í Þýskalandi.",
      [
        "Aðalverkefni mitt var að kenna stærðfræði og ensku í grunnskóla og framhaldsskóla.",
        "Tók einnig þátt í þróun kennsluefna og kennsluáætlana."
      ]
    ],
    "de": [
  ...
  8: {
    ...
    "dk": [
      "En liste over job siden barndommen:",
      [
        "Reklameudgiver, rengøringsmiddel, sælger, telefonhandler, lærer, rejseguide og arrangementarrangør.",
        "Har arbejdet i Sverige, Spanien, Portugal, Thailand, Cambodja og Japan."
      ]
    ],
    "is": [
      "Listi yfir vinnu síðan barnæsku minni:",
      [
        "Auglýsingadrengur, húsvörður, sölumaður, símamaður, kennari, ferðaþjónn og viðburðir.",
        "Hef unnið í Svíþjóð, Spáni, Portúgal, Taílandi, Kambódíu og Japan."
      ]
    ],
    "de": [
    ...
    "vn": [
      "Danh sách các công việc tôi đã làm từ khi còn nhỏ:",
      [
        "Phát tờ rơi, dọn dẹp, bán hàng, telesales, giảng dạy, hướng dẫn viên du lịch và tổ chức sự kiện.",
        "Tôi đã làm việc tại Thụy Điển, Tây Ban Nha, Bồ Đào Nha, Thái Lan, Campuchia và Nhật Bản."
      ]
    ],
    "th": [
...
const institution_names = {
  ...
  "KTH": {
    ...
    "dk": "Kongelige Tekniske Højskole",
    "is": "Konunglega Tækniháskólinn",
  ...
  "SU": {
    ...
    "dk": "Stockholms Universitet",
    "is": "Háskóli Stokkhólms",
...
const education_description = {
  1: {
    "us": [
      ...
      [
        "We learned Vue and React, but I developed an interest in Svelte over Vue and React.",
        "Remote internship with a Swedish agriculture company based in Thailand."
      ]
    ],
    "se": [
      "Lexicon erbjuder yrkesutbildningar i Sverige. Praktik och utbildning som frontend-utvecklare.",
      [
        "Vi lärde oss Vue och React, men jag fattade intresse för Svelte istället för Vue och React.",
    ...
    "fi": [
      ...
      [
        "Opimme Vue ja React, mutta kiinnostuin Sveltestä Vue ja Reactin sijaan.",
    ...
    "dk": [
      "Lexicon tilbyder erhvervsuddannelse i Sverige. Praktik og uddannelse i frontend-udvikling.",
      [
        "Vi lærte Vue og React, men jeg fik interesse for Svelte i stedet for Vue og React.",
        "Fjernpraktik med et svensk landbrugsselskab med base i Thailand."
      ]
    ],
    "is": [
      "Lexicon býður upp á atvinnufræðslu í Svíþjóð. Starfsþjálfun og menntun í framendaþróun.",
      [
        "Við lærðum Vue og React, en ég fékk áhuga á Svelte í stað Vue og React.",
        "Fjartengd starfsþjálfun með sænska landbúnaðarfélagi með sessi í Taílandi."
      ]
    ],
    "de": [
    ...
    "vn": [
      "Lexicon cung cấp giáo dục nghề nghiệp tại Thụy Điển. Thực tập với vai trò Nhà phát triển giao diện hệ thống.",
      [
        "Chúng tôi đã học Vue và React, nhưng tôi hứng thú với Svelte hơn là Vue và React.",
        "Thực tập từ xa với một công ty nông nghiệp Thụy Điển có trụ sở tại Thái Lan."
      ]
    ],
    "th": [
  ...
  2: {
    ...
    "dk": [
      "Afsluttede kandidatgrad i teknisk fysik",
      [
        "Afsluttede 5-årig kandidatgrad i teknisk fysik.",
        "Hovedfag: Anvendt matematik og beregningsvidenskab.",
        "Afhandlingstitel: Invers parameterestimering ved hjælp af Hamilton-Jacobi-ligninger.",
        "http://kth.diva-portal.org/smash/get/diva2:624555/FULLTEXT03.pdf"
      ]
    ],
    "is": [
      "Lokið meistaraprófi í verkfræði",
      [
        "Lokið 5 ára meistaraprófi í verkfræði frá verkfræðideildinni.",
        "Aðal: Stærðfræði og reiknifræði.",
        "Ritgerðarheiti: Inverse Parameter Estimation með Hamilton-Jacobi jöfnur.",
        "http://kth.diva-portal.org/smash/get/diva2:624555/FULLTEXT03.pdf"
      ]
    ],
    "de": [
    ...
    "vn": [
      "Hoàn thành bằng Thạc sĩ Khoa học Kỹ thuật Vật lý",
      [
        "Hoàn thành chương trình Thạc sĩ Khoa học Kỹ thuật 5 năm tại Trường Kỹ thuật Vật lý.",
        "Chuyên ngành: Toán ứng dụng và Khoa học tính toán.",
        "Luận văn: Ước lượng tham số nghịch đảo bằng cách sử dụng phương trình Hamilton-Jacobi.",
        "http://kth.diva-portal.org/smash/get/diva2:624555/FULLTEXT03.pdf"
      ]
    ],
    "th": [
  ...
  3: {
    ...
    "dk": [
      [
        "Afsluttede 4 år + 7 måneder af kandidatgraden i teknisk fysik.",
        "GPA: 3.7 ud af 5.0"
      ]
    ],
    "is": [
      [
        "Lokið 4 árum + 7 mánuðum af verkfræði meistaraprófi.",
        "Meðal einkunn: 3.7 af 5.0"
      ]
    ],
    "de": [
      [
    ...
    "vn": [
      [
        "Hoàn thành 4 năm + 7 tháng trong chương trình Kỹ thuật Vật lý.",
        "GPA: 3.7 trên 5.0"
      ]
    ],
    "th": [
  ...
  4: {
    ...
    "dk": [
      [
        "Begyndte kandidatgraden i teknisk fysik."
      ]
    ],
    "is": [
      [
        "Hóf meistaraprófið í verkfræði."
      ]
    ],
    "de": [
      [
    ...
    "vn": [
      [
        "Bắt đầu chương trình Thạc sĩ Khoa học Kỹ thuật Vật lý."
      ]
    ],
    "th": [
      [
  ...
  5: {
    "us": [
      [
        "Completed 1.5 years of study in the Mathematics and Nature Sciences Program."
      ]
    ],
    "se": [
      [
    ...
    "dk": [
      [
        "Afsluttede 1,5 års studier af matematik og naturvidenskab."
      ]
    ],
    "is": [
      [
        "Lokið 1,5 ára námi í stærðfræði og náttúrufræði."
      ]
    ],
    "de": [
      [
    ...
    "vn": [
      [
        "Hoàn thành 1,5 năm học trong chương trình Toán học và Khoa học Tự nhiên."
      ]
    ],
    "th": [
      [
...
const language_ratings_description = {
  ...
  "dk": {
    0: "Kan ikke tale dette sprog",
    1: "Grundlæggende, kan håndtere lidt småsnak",
    2: "Mellemliggende, kan holde en samtale",
    3: "Dygtig, kan læse og skrive godt",
    4: "Flydende, andet sprog",
    5: "Modersmål"
  },
  "is": {
    0: "Getur ekki talað þetta tungumál",
    1: "Grunnstig, getur haldið uppi smá spjalli",
    2: "Millistig, getur haldið samtali",
    3: "Hæfur, getur lesið og skrifað vel",
    4: "Reiprennandi, annað tungumál",
    5: "Móðurmál"
  },
  "de": {
  ...
  "vn": {
    0: "Không thể nói ngôn ngữ này",
    1: "Cơ bản, có thể giao tiếp đơn giản",
    2: "Trung cấp, có thể trò chuyện",
    3: "Thành thạo, có thể đọc và viết tốt",
    4: "Lưu loát, ngôn ngữ thứ hai",
    5: "Bản ngữ, tiếng mẹ đẻ"
  },
  "th": {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function formatLanguageSkills(lang = language) {
    if (!language_names[lang]) {
      console.warn(`Missing language data for: ${lang}, using 'us' fallback.`);
      lang = "us";
    }
    let result = "";
    for (const [language_code, language_skill] of Object.entries(mikael_language_skills)) {
      let language_name = language_names[lang][language_code] || language_names["us"][language_code] || "Unknown";
      let rating = language_ratings_description[lang][language_skill] || language_ratings_description["us"][language_skill] || "N/A";
      result += `${language_name}: ${rating}<br>`;
    }
    return result;
  }
  $$result.css.add(css);
...
//# sourceMappingURL=_page.svelte-gxvIV4ou.js.map
