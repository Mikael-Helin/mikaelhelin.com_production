import { c as create_ssr_component, a as subscribe, e as escape, b as each } from './ssr-IT87nZNo.js';
...
const introduction = {
  ...
  "dk": "Født og opvokset i Stockholm, Sverige med rødder fra Finland. Allerede i tidlig barndom fascinerede videnskaben mig, hvilket tændte mig til at blive den beregningsforsker, jeg er i dag. Nysgerrig på verden besøgte jeg over 30 lande, fik dykkercertifikater og udforskede forskellige kulturer. Jeg håber at bære min entusiasme ind i mit arbejde og at fordybe mig i udfordringer at tackle.",
  "is": "Fæddur og uppalinn í Stokkhólmi, Svíþjóð með rætur frá Finnlandi. Þegar ég var enn ungur, heillaði vísindin mig, sem kveikti í mér til að verða reiknifræðingurinn sem ég er í dag. Forvitinn um heiminn, heimsótti ég yfir 30 lönd, fékk könnunarvottorð og kannaði mismunandi menningu. Ég vona að bera andann minn af áhuga inn í vinnuna mína og að grafa í áskorunum til að takast á við.",
  ...
  "il": "נולד וגדל בשטוקהולם, שוודיה עם שורשים מפינלנד. כבר בילדותיו המוקדמת, המדע הפשיע אותי, מה שהפעיל אותי להיות המדען החישובי שאני היום. סקרן על העולם, ביקרתי ביותר מ-30 מדינות, קיבלתי תעודות צלילה וחקרתי תרבויות שונות. אני מקווה להביא את רוח ההתלהבות שלי לעבודה שלי ולהעמיק באתגרים להתמודד.",
  "ae": "ستوكهولم ، السويد مع جذور من فنلندا. بالفعل في الطفولة المبكرة ، أثارت العلوم اهتمامي ، مما أشعلني لأصبح العالم الحاسوبي الذي أنا عليه اليوم. فضولي حول العالم ، زرت أكثر من 30 دولة ، وحصلت على شهادات الغوص واستكشفت ثقافات مختلفة. آمل أن أحمل روح حماسي إلى عملي وأن أغوص في التحديات للتعامل معها.",
...
//# sourceMappingURL=_page.svelte-d-NmB4qO.js.map
