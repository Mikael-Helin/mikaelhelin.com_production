import{s as w,f as _,l as g,g as m,z as E,m as d,h as p,d as c,i as u,w as b,A,j as k,u as x,n as D}from"../chunks/scheduler.CwkLdD99.js";import{e as y}from"../chunks/each.-gASlQSi.js";import{S as F,i as L}from"../chunks/index.DUq0o2rG.js";function C(o,n,s){const l=o.slice();return l[1]=n[s].slug,l[2]=n[s].title,l}function T(o){let n,s,l=o[2]+"",r,h;return{c(){n=_("li"),s=_("a"),r=g(l),this.h()},l(i){n=m(i,"LI",{});var t=p(n);s=m(t,"A",{href:!0});var e=p(s);r=d(e,l),e.forEach(c),t.forEach(c),this.h()},h(){k(s,"href",h="/blog/"+o[1])},m(i,t){u(i,n,t),x(n,s),x(s,r)},p(i,t){t&1&&l!==(l=i[2]+"")&&D(r,l),t&1&&h!==(h="/blog/"+i[1])&&k(s,"href",h)},d(i){i&&c(n)}}}function S(o){let n,s="Blog",l,r,h,i=y(o[0].summaries),t=[];for(let e=0;e<i.length;e+=1)t[e]=T(C(o,i,e));return{c(){n=_("h1"),n.textContent=s,l=g(`
